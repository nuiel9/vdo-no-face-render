# YOUTUBE: How a Seed Shop Became Asia's Biggest Hidden Empire
Row #47 | CP Group | UTM: business-pm-cp-group
...
## Chapters (6, approximate timestamps)

0:00 - The Seed Shop: Bangkok, 1921
1:10 - The Vertical Integration Logic
2:30 - CP Foods: The Invisible Protein Empire
3:45 - China's First Foreign Investor: Shenzhen, 1978
5:00 - 7-Eleven Thailand: 14,000 Stores
6:20 - Tesco, Lotus's, True+DTAC: Completing the Stack
...
#CPGroup #CharoenPokphand #SEAbusiness #BusinessCaseStudy #ThailandBusiness #ConglomerateStrategy #VerticalIntegration #DisclosedBusiness

---

## Pinned Comment Draft

FACT-CHECK WINDOW: Three figures in this video move quarterly and should be verified against the latest filings before publishing.

(1) 7-Eleven store count: script uses approximately 14,000 (CP All 2023 AR). Verify against the most recent CP All PCL quarterly filing on the SET portal.

(2) Daily transaction volume: script uses 14 million/day. Verify against the same CP All AR or investor presentation.
